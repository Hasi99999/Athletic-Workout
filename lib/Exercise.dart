...
class _ExercisePageState extends State<ExercisePage> {
  // String sportEvent = '800M'; // Default value or you can set it to null initially
  // String competitionDuration = '3months';
  ...
  void getUserData() async {
    try {
      // Replace 'userId' with the actual user ID from FirebaseAuth if needed
      ...
      if (userId != null) {
        ...
        if (userDoc.exists) {
          setState(() {
            sportEvent = userDoc.data()?['sportEvent'] ?? 'Unknown'; // Safely access 'sportEvent'
            competitionDuration = userDoc.data()?['competitionDuration'] ?? 'Unknown'; // Safely access 'competitionDuration'
          });
        } else {
                        ...
                        child: SingleChildScrollView(
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              String currentWorkOut = workOut ?? day01; // Provide a default value or handle this case
