...
class _HomePageState extends State<HomePage> {
  ...
  _getCompetitionDuration() async {
    if (user != null) {
      DocumentSnapshot userDoc = await FirebaseFirestore.instance.collection('users').doc(user!.uid).get();
      setState(() {
        competitionDuration = userDoc['competitionDuration'];
      });
    }
  }
                ...
                Container(
                  ...
                  child: Container(
                    padding: const EdgeInsets.only(
                        left: 20, top: 20, right: 20, bottom: 6),
                    child: Column(
                          ...
                          children: [
                            ...
                            RichText(
                                text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(text: "stick to your workout")
                                    ]))
                          ],
                        ),
                      )
